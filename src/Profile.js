   ...
   const [{user},diapatch]=useStateValue();
    ...
    return(
        <div className="profile-details">
            <form style={{position:"fixed",backgroundColor:"grey",color:"white",border:"5px solid white",textAlign:"center",margin:"10px",height:"fit-content",width:"fit-content",padding:"20px"}}>
